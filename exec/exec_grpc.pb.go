...
type ExecClient interface {
	Execute(ctx context.Context, in *ExeSpec, opts ...grpc.CallOption) (*ExeResponse, error)
}
...
func (c *execClient) Execute(ctx context.Context, in *ExeSpec, opts ...grpc.CallOption) (*ExeResponse, error) {
	out := new(ExeResponse)
	err := c.cc.Invoke(ctx, "/exec.Exec/Execute", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExecServer interface {
	Execute(context.Context, *ExeSpec) (*ExeResponse, error)
...
func (UnimplementedExecServer) Execute(context.Context, *ExeSpec) (*ExeResponse, error) {
...
func _Exec_Execute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExeSpec)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExecServer).Execute(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/exec.Exec/Execute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExecServer).Execute(ctx, req.(*ExeSpec))
	}
